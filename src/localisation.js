...
i18nextko.init({
  "en": {
    "translation": {
      ...
      "shaperminpausetime": "Minimum time staying in pause ( in s)",
      "shapermaxinterval": "Max time between live power data before entering failsafe (in s)",
      "shapersmoothing": "Input Filter Time constant",
      "shapersmoothingdesc": "Time constant for the input filter used to get out of pause (in sec). Value of 0 means no filtering",
      "ohm": "OhmConnect",
      ...
      "divertsmoothatt": "Divert smoothing attack (in sec):",
      "divertsmoothattdesc": "The time constant value used for the input filter when increasing power (in sec). Value of 0 means no filtering",
      "divertsmoothdec": "Divert smoothing decay (in sec):",
      "divertsmoothdecdesc": "The time constant value used for the input filter when decreasing power (in sec). Value of 0 means no filtering",
  ...
  "fr": {
    "translation": {
      ...
      "shaperminpausetime": "Temps minimum en pause ( en s)",
      "shapermaxinterval": "Intervalle max entre 2 mises à jours de puissance instanée avant de se mettre en sécurité. ( en s)",
      "shapersmoothing": "Constante temps filtre d'entrée",
      "shapersmoothingdesc": "Constante de temps du filtre d'augmentation de la puissance en pause (sec). Une valeur 0 signifie pas de lissage.",
      "ohm": "OhmConnect",
      ...
      "divertsmoothatt": "Filtrage augmentation puissance (sec):",
      "divertsmoothattdesc": "Constante de temps du filtre pour l'augmentation de la puissance. Une valeur 0 désactive le filtre",
      "divertsmoothdec": "Filtrage diminution de la puissance (sec):",
      "divertsmoothdecdesc": "Constante de temps du filtre pour l'augmentation de la puissance. Une valeur 0 désactive le filtre",
